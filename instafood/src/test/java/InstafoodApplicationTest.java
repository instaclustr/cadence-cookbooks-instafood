...
class InstafoodApplicationTest {
    ...
    public void givenAnOrderItShouldBeSentToMegaBurgerAndBeDeliveredAccordingly() {
        ...
        await().until(
                () -> workflowHistoryHasEvent(workflowClient, workflowExecution, EventType.WorkflowExecutionCompleted));
    }
    ...
    public void givenAnOrderWhenMegaBurgerRejectsItShouldEndWorkflow() {
        ...
        await().until(
                () -> workflowHistoryHasEvent(workflowClient, workflowExecution, EventType.WorkflowExecutionFailed));
    }
    ...
    public void givenAnOrderWithDeliveryItShoulBeSentToMegaBurgerAndDeliveredByACourierAccordingly() {
        ...
        await().until(() -> getOpenCourierDeliveryWorkflowsWithParentId(workflowExecution.getWorkflowId()).size() != 0);
        ...
        CourierDeliveryWorkflow courierDeliveryWorkflow = workflowClient.newWorkflowStub(CourierDeliveryWorkflow.class,
                    ...
                    .ListOpenWorkflowExecutions(
                            new ListOpenWorkflowExecutionsRequest()
                                    ...
                                    .setStartTimeFilter(new StartTimeFilter()
                                            .setEarliestTime(0)
                                            .setLatestTime(Instant.now().toEpochMilli() * 1000000))
                                    .setTypeFilter(
                                            new WorkflowTypeFilter().setName("CourierDeliveryWorkflow::deliverOrder")))
